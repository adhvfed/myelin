...
pub use migrations::{
    ...
    ISSUE_ASSIGNEE_INDEX, ISSUE_AUTHZ_BINDING_TABLE, ISSUE_BOARD_INDEX, ISSUE_CHANGE_LOG_TABLE,
    ISSUE_CYCLE_INDEX, ISSUE_PARENT_INDEX, ISSUE_PROPS_GIN_INDEX, ISSUE_RELATION_TABLE,
    ISSUE_ROADMAP_INDEX, ISSUE_TABLE, MILESTONE_TABLE, OUTBOX_TABLE, PREFIX_COUNTER_TABLE,
