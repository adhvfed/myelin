...
pub const ACTION_REQUIREMENTS: &[ActionRequirement] = &[
    ...
    requirement!("identity.agent_threads.list", "agent.view", HUMAN_SESSION),
    requirement!(
        "identity.agent_thread.create",
        "agent.manage",
        HUMAN_SESSION
    ...
    requirement!("notif.inbox.snooze", "notification.write", OP_PAT),
    requirement!("notif.inbox.mark_all_read", "notification.write", OP_PAT),
    ...
    requirement!("chat.message.view", "chat.read", OP_PAT),
    requirement!("chat.message.post", "chat.post", OP_PAT),
    requirement!("chat.thread.messages.list", "chat.read", OP_PAT),
    requirement!("chat.thread.follow", "chat.read", OP_PAT),
    requirement!("chat.thread.mute", "chat.read", OP_PAT),
    requirement!("chat.reply.post", "chat.post", OP_PAT),
    ...
    requirement!("knowledge.page.link", "knowledge.edit", OP_PAT),
