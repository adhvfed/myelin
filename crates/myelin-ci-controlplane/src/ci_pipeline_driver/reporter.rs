...
use super::completion::{
    ...
    workload_disposition, ClaimRefusal, CompletionReceiptInput, CompletionReceipts,
...
use super::{
    ...
    verify_preparation_retry_permitted_on_conn, CompletionTxError, DurableCiJobAccounting,
    PreparationRetryGate, TerminalAccountingInput, TerminalUsageResolutionInput,
};
