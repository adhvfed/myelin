...
myelin agent create "Review companion" --tool ci.read_run --tool git.open_pr \
  ...
  --tool projects.list --tool issues.list --tool issues.view \
...
myelin issue list
myelin issue view DX-1
myelin issue relation add DX-1 blocks \
  myelin://acme/issue/issue/DX-2 --idempotency-key block-release
myelin issue relation list DX-1
myelin issue relation remove DX-1 \
  55555555-5555-5555-5555-555555555555
myelin issue close DX-1
...
myelin chat reply 01J... "Keep this decision with its root." --idempotency-key release-reply
myelin chat thread 01J...
