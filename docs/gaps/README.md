...
What's deliberately unfinished. One file per area. Keep entries terse: what's
missing, why it's deferred, what "done" looks like. Delete an entry when it's closed.
